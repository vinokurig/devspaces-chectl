...
export namespace EclipseChe {
  ...
  // Doc links
  export const DOC_LINK = 'https://access.redhat.com/documentation/en-us/red_hat_openshift_dev_spaces/3.19/'
  export const DOC_LINK_RELEASE_NOTES = 'https://access.redhat.com/documentation/en-us/red_hat_openshift_dev_spaces/3.19/html/release_notes_and_known_issues/index'
